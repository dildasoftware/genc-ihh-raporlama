...
const navItems = [
  ...
  { href: '/trend',         label: 'Trend',             icon: TrendingUp,      roles: ['IL_KOORDINATOR','MERKEZ_BIRIM_BASKANI','ADMIN'], section: 'analyze' },
  { href: '/karsilastir',   label: 'Karşılaştır',       icon: BarChart2,       roles: ['MERKEZ_BIRIM_BASKANI','ADMIN'], section: 'analyze' },
  { href: '/haftalik-rapor',label: 'Haftalık Rapor',    icon: FileText,        roles: ['IL_KOORDINATOR','MERKEZ_BIRIM_BASKANI','ADMIN'], section: 'reports' },
